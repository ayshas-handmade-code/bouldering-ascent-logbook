  ...
  return (
    ...
    >
      ...
      <div className={`${styles.icon_title_container} flex items-center justify-between gap-4`}>
        {/* Icon & Titles */}
        <div className={`${styles.width_100} flex items-center gap-3 min-w-0`}>
          {/* Icon */}
          ...
          {/* Title & Details */}
          <div className={`${styles.width_100} min-w-0`}>
            <div className={`${styles.width_100} flex items-center gap-2`}>
            ...
            <div className="flex items-center gap-3 mt-2 text-[10px] font-display font-bold text-choco-medium">
              ...
              {/* Actions */}
              <div className={`${styles.action_button_container} flex items-center gap-1.5 shrink-0`}>
                <button
